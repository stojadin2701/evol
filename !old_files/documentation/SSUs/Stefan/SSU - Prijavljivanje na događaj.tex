...
PRIJAVLJIVANJE NA DOGAĐAJ\par}\vspace{-1mm}
...
\section{Uvod}
\subsection{Rezime}
Definisanje scenarija upotrebe pri prijavljivanju na događaj, sa primerima odgovarajućih HTML stranica.
...
Korisnici mogu da se prijavljuju na aktuelne događaje koji ih interesuju sa stranice tog događaja.

\subsection{Tok događaja}
\subsubsection{\underline{Korisnik se prijavljuje na događaj}}
\begin{enumerate}
    \item Klikom na dugme \textit{Sign up} korisnik se prijavljuje na događaj
    \item Sistem prikazuje poruku o uspešnoj prijavi
\end{enumerate}

\subsection{Posebni zahtevi}
Nema
\subsection{Preduslovi}
Korisnik sa nalazi na stranici događaja za koji je zainteresovan.
\subsection{Posledice}
Korisnik se prijavio na događaj.
